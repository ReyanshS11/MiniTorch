...
from mini_torch.nn.layers import Linear, ReLU, Conv1d, Conv2d
...
x = Tensor(np.random.randn(4, 3, 10, 10), requires_grad=True)
#x = torch.randn((4, 3, 10, 10), requires_grad=True)
